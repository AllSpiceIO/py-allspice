...
class RepositoryApi(object):
    ...
    def repo_get_all_spice_json(self, owner, repo, filepath, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_get_all_spice_json(owner, repo, filepath, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param str filepath: filepath of the cad file to get JSON for (required)
        :param str ref: The name of the commit/branch/tag. Default the repository’s default branch (usually main)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_get_all_spice_json_with_http_info(owner, repo, filepath, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_get_all_spice_json_with_http_info(owner, repo, filepath, **kwargs)  # noqa: E501
            return data

    def repo_get_all_spice_json_with_http_info(self, owner, repo, filepath, **kwargs):  # noqa: E501
        """Get the json blob for a cad file if it exists, otherwise enqueue a new job and return a 503 status. Note: This is still experimental and not yet recommended for critical applications.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_get_all_spice_json_with_http_info(owner, repo, filepath, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_get_all_spice_json" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if ('owner' not in params or
                params['owner'] is None):
            raise ValueError("Missing the required parameter `owner` when calling `repo_get_all_spice_json`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if ('repo' not in params or
                params['repo'] is None):
            raise ValueError("Missing the required parameter `repo` when calling `repo_get_all_spice_json`")  # noqa: E501
        # verify the required parameter 'filepath' is set
        if ('filepath' not in params or
                params['filepath'] is None):
            raise ValueError("Missing the required parameter `filepath` when calling `repo_get_all_spice_json`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/allspice_generated/json/{filepath}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_get_all_spice_svg(self, owner, repo, filepath, **kwargs):  # noqa: E501
        """Get the svg blob for a cad file if it exists, otherwise enqueue a new job and return 503 status. Note: This is still experimental and not yet recommended for critical applications.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_get_all_spice_svg(owner, repo, filepath, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param str filepath: filepath of the cad file to get SVG for (required)
        :param str ref: The name of the commit/branch/tag. Default the repository’s default branch (usually main)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_get_all_spice_svg_with_http_info(owner, repo, filepath, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_get_all_spice_svg_with_http_info(owner, repo, filepath, **kwargs)  # noqa: E501
            return data

    def repo_get_all_spice_svg_with_http_info(self, owner, repo, filepath, **kwargs):  # noqa: E501
        """Get the svg blob for a cad file if it exists, otherwise enqueue a new job and return 503 status. Note: This is still experimental and not yet recommended for critical applications.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_get_all_spice_svg_with_http_info(owner, repo, filepath, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_get_all_spice_svg" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if ('owner' not in params or
                params['owner'] is None):
            raise ValueError("Missing the required parameter `owner` when calling `repo_get_all_spice_svg`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if ('repo' not in params or
                params['repo'] is None):
            raise ValueError("Missing the required parameter `repo` when calling `repo_get_all_spice_svg`")  # noqa: E501
        # verify the required parameter 'filepath' is set
        if ('filepath' not in params or
                params['filepath'] is None):
            raise ValueError("Missing the required parameter `filepath` when calling `repo_get_all_spice_svg`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/allspice_generated/svg/{filepath}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
