...
class CreateRepoOption(object):
    ...
    def __init__(self, auto_init=None, create_develop_branch=None, default_branch=None, description=None, gitignores=None, issue_labels=None, license=None, name=None, private=None, readme=None, template=None, trust_model=None):  # noqa: E501
