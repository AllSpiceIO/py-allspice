...
from allspice_client.models.generate_repo_option import GenerateRepoOption  # noqa: E501
...
class TestGenerateRepoOption(unittest.TestCase):
    ...
    def testGenerateRepoOption(self):
        ...
        # model = allspice_client.models.generate_repo_option.GenerateRepoOption()  # noqa: E501
        pass
