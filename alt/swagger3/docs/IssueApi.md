...
api_instance = allspice_client.IssueApi(allspice_client.ApiClient(configuration))
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the issue
body = allspice_client.IssueLabelsOption() # IssueLabelsOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the issue
body = allspice_client.AddTimeOption() # AddTimeOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the issue
body = allspice_client.CreateIssueCommentOption() # CreateIssueCommentOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateIssueOption() # CreateIssueOption |  (optional)
...
> Attachment issue_create_issue_attachment(attachment, owner, repo, index, name=name)
...
try:
    # Create an issue attachment
    api_response = api_instance.issue_create_issue_attachment(attachment, owner, repo, index, name=name)
    pprint(api_response)
except ApiException as e:
...
> Attachment issue_create_issue_comment_attachment(attachment, owner, repo, id, name=name)
...
try:
    # Create a comment attachment
    api_response = api_instance.issue_create_issue_comment_attachment(attachment, owner, repo, id, name=name)
    pprint(api_response)
except ApiException as e:
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateLabelOption() # CreateLabelOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateMilestoneOption() # CreateMilestoneOption |  (optional)
...
body = allspice_client.EditReactionOption() # EditReactionOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
id = 789 # int | id of the comment to edit
body = allspice_client.EditIssueCommentOption() # EditIssueCommentOption |  (optional)
...
body = allspice_client.EditIssueOption() # EditIssueOption |  (optional)
...
body = allspice_client.EditDeadlineOption() # EditDeadlineOption |  (optional)
...
body = allspice_client.EditLabelOption() # EditLabelOption |  (optional)
...
body = allspice_client.EditMilestoneOption() # EditMilestoneOption |  (optional)
