...
from allspice_client.models.node_info_usage_users import NodeInfoUsageUsers  # noqa: E501
...
class TestNodeInfoUsageUsers(unittest.TestCase):
    ...
    def testNodeInfoUsageUsers(self):
        ...
        # model = allspice_client.models.node_info_usage_users.NodeInfoUsageUsers()  # noqa: E501
        pass
