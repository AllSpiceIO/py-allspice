...
from allspice_client.models.notification_thread import NotificationThread  # noqa: E501
...
class TestNotificationThread(unittest.TestCase):
    ...
    def testNotificationThread(self):
        ...
        # model = allspice_client.models.notification_thread.NotificationThread()  # noqa: E501
        pass
