...
from allspice_client.models.commit_affected_files import CommitAffectedFiles  # noqa: E501
...
class TestCommitAffectedFiles(unittest.TestCase):
    ...
    def testCommitAffectedFiles(self):
        ...
        # model = allspice_client.models.commit_affected_files.CommitAffectedFiles()  # noqa: E501
        pass
