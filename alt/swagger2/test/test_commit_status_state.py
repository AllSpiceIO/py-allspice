...
from allspice_client.models.commit_status_state import CommitStatusState  # noqa: E501
...
class TestCommitStatusState(unittest.TestCase):
    ...
    def testCommitStatusState(self):
        ...
        # model = allspice_client.models.commit_status_state.CommitStatusState()  # noqa: E501
        pass
