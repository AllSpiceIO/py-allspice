# allspice_client.OrganizationApi
...
api_instance = allspice_client.OrganizationApi(allspice_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = allspice_client.OrganizationApi(allspice_client.ApiClient(configuration))
organization = allspice_client.CreateOrgOption() # CreateOrgOption | 
...
api_instance = allspice_client.OrganizationApi(allspice_client.ApiClient(configuration))
org = 'org_example' # str | name of the organization
body = allspice_client.CreateHookOption() # CreateHookOption | 
...
api_instance = allspice_client.OrganizationApi(allspice_client.ApiClient(configuration))
org = 'org_example' # str | name of the organization
body = allspice_client.CreateTeamOption() # CreateTeamOption |  (optional)
...
body = allspice_client.EditOrgOption() # EditOrgOption | 
...
body = allspice_client.EditTeamOption() # EditTeamOption |  (optional)
