...
[**repo_get_all_spice_json**](RepositoryApi.md#repo_get_all_spice_json) | **GET** /repos/{owner}/{repo}/allspice_generated/json/{filepath} | Get the json blob for a cad file if it exists, otherwise enqueue a new job and return a 503 status. Note: This is still experimental and not yet recommended for critical applications.
[**repo_get_all_spice_svg**](RepositoryApi.md#repo_get_all_spice_svg) | **GET** /repos/{owner}/{repo}/allspice_generated/svg/{filepath} | Get the svg blob for a cad file if it exists, otherwise enqueue a new job and return 503 status. Note: This is still experimental and not yet recommended for critical applications.
...
api_instance = allspice_client.RepositoryApi(allspice_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = allspice_client.RepositoryApi(allspice_client.ApiClient(configuration))
body = allspice_client.CreateRepoOption() # CreateRepoOption |  (optional)
...
body = allspice_client.CreateForkOption() # CreateForkOption |  (optional)
...
body = allspice_client.GenerateRepoOption() # GenerateRepoOption |  (optional)
...
body = allspice_client.AddCollaboratorOption() # AddCollaboratorOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreatePushMirrorOption() # CreatePushMirrorOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.UpdateFileOptions() # UpdateFileOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateBranchRepoOption() # CreateBranchRepoOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateBranchProtectionOption() # CreateBranchProtectionOption |  (optional)
...
body = allspice_client.CreateFileOptions() # CreateFileOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateHookOption() # CreateHookOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateKeyOption() # CreateKeyOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreatePullRequestOption() # CreatePullRequestOption |  (optional)
...
body = allspice_client.CreatePullReviewOptions() # CreatePullReviewOptions | 
...
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the pull request
body = allspice_client.PullReviewRequestOptions() # PullReviewRequestOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateReleaseOption() # CreateReleaseOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
sha = 'sha_example' # str | sha of the commit
body = allspice_client.CreateStatusOption() # CreateStatusOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateTagOption() # CreateTagOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.CreateWikiPageOptions() # CreateWikiPageOptions |  (optional)
...
body = allspice_client.DeleteFileOptions() # DeleteFileOptions | 
...
index = 789 # int | index of the pull request
id = 789 # int | id of the review
body = allspice_client.DismissPullReviewOptions() # DismissPullReviewOptions | 
...
body = allspice_client.EditRepoOption() # EditRepoOption | Properties of a repo that you can edit (optional)
...
repo = 'repo_example' # str | name of the repo
name = 'name_example' # str | name of protected branch
body = allspice_client.EditBranchProtectionOption() # EditBranchProtectionOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
id = 'id_example' # str | id of the hook to get
body = allspice_client.EditGitHookOption() # EditGitHookOption |  (optional)
...
body = allspice_client.EditHookOption() # EditHookOption |  (optional)
...
body = allspice_client.EditPullRequestOption() # EditPullRequestOption |  (optional)
...
body = allspice_client.EditReleaseOption() # EditReleaseOption |  (optional)
...
body = allspice_client.EditAttachmentOptions() # EditAttachmentOptions |  (optional)
...
# **repo_get_all_spice_json**
> repo_get_all_spice_json(owner, repo, filepath, ref=ref)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
filepath = 'filepath_example' # str | filepath of the cad file to get JSON for
ref = 'ref_example' # str | The name of the commit/branch/tag. Default the repository’s default branch (usually main) (optional)

try:
    # Get the json blob for a cad file if it exists, otherwise enqueue a new job and return a 503 status. Note: This is still experimental and not yet recommended for critical applications.
    api_instance.repo_get_all_spice_json(owner, repo, filepath, ref=ref)
except ApiException as e:
    print("Exception when calling RepositoryApi->repo_get_all_spice_json: %s\n" % e)
```
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **filepath** | **str**| filepath of the cad file to get JSON for | 
 **ref** | **str**| The name of the commit/branch/tag. Default the repository’s default branch (usually main) | [optional] 
...
# **repo_get_all_spice_svg**
> repo_get_all_spice_svg(owner, repo, filepath, ref=ref)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
filepath = 'filepath_example' # str | filepath of the cad file to get SVG for
ref = 'ref_example' # str | The name of the commit/branch/tag. Default the repository’s default branch (usually main) (optional)

try:
    # Get the svg blob for a cad file if it exists, otherwise enqueue a new job and return 503 status. Note: This is still experimental and not yet recommended for critical applications.
    api_instance.repo_get_all_spice_svg(owner, repo, filepath, ref=ref)
except ApiException as e:
    print("Exception when calling RepositoryApi->repo_get_all_spice_svg: %s\n" % e)
```
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **filepath** | **str**| filepath of the cad file to get SVG for | 
 **ref** | **str**| The name of the commit/branch/tag. Default the repository’s default branch (usually main) | [optional] 
...
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the pull request to merge
body = allspice_client.MergePullRequestOption() # MergePullRequestOption |  (optional)
...
# create an instance of the API class
api_instance = allspice_client.RepositoryApi(allspice_client.ApiClient(configuration))
body = allspice_client.MigrateRepoOptions() # MigrateRepoOptions |  (optional)
...
index = 789 # int | index of the pull request
id = 789 # int | id of the review
body = allspice_client.SubmitPullReviewOptions() # SubmitPullReviewOptions | 
...
owner = 'owner_example' # str | owner of the repo to transfer
repo = 'repo_example' # str | name of the repo to transfer
body = allspice_client.TransferRepoOption() # TransferRepoOption | Transfer Options
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = allspice_client.RepoTopicOptions() # RepoTopicOptions |  (optional)
