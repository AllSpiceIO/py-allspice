...
api_instance = allspice_client.AdminApi(allspice_client.ApiClient(configuration))
...
key = allspice_client.CreateKeyOption() # CreateKeyOption |  (optional)
...
repository = allspice_client.CreateRepoOption() # CreateRepoOption | 
...
# create an instance of the API class
api_instance = allspice_client.AdminApi(allspice_client.ApiClient(configuration))
body = allspice_client.CreateUserOption() # CreateUserOption |  (optional)
...
body = allspice_client.EditUserOption() # EditUserOption |  (optional)
