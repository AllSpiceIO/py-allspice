...
api_instance = allspice_client.UserApi(allspice_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = allspice_client.UserApi(allspice_client.ApiClient(configuration))
body = allspice_client.UserSettingsOptions() # UserSettingsOptions |  (optional)
...
# create an instance of the API class
api_instance = allspice_client.UserApi(allspice_client.ApiClient(configuration))
body = allspice_client.CreateEmailOption() # CreateEmailOption |  (optional)
...
# create an instance of the API class
api_instance = allspice_client.UserApi(allspice_client.ApiClient(configuration))
body = allspice_client.CreateOAuth2ApplicationOptions() # CreateOAuth2ApplicationOptions | 
...
body = allspice_client.CreateAccessTokenOption() # CreateAccessTokenOption |  (optional)
...
# create an instance of the API class
api_instance = allspice_client.UserApi(allspice_client.ApiClient(configuration))
form = allspice_client.CreateGPGKeyOption() # CreateGPGKeyOption |  (optional)
...
# create an instance of the API class
api_instance = allspice_client.UserApi(allspice_client.ApiClient(configuration))
body = allspice_client.DeleteEmailOption() # DeleteEmailOption |  (optional)
