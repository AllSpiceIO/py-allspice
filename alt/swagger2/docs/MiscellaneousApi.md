# allspice_client.MiscellaneousApi
...
[**get_version**](MiscellaneousApi.md#get_version) | **GET** /version | Returns the version of the AllSpice application
...
api_instance = allspice_client.MiscellaneousApi(allspice_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = allspice_client.MiscellaneousApi(allspice_client.ApiClient(configuration))
body = allspice_client.MarkdownOption() # MarkdownOption |  (optional)
