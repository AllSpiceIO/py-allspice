...
class CreateRepoOption(object):
    ...
    def __init__(self, auto_init=None, create_develop_branch=None, default_branch=None, description=None, gitignores=None, issue_labels=None, license=None, name=None, private=None, readme=None, template=None, trust_model=None, _configuration=None):  # noqa: E501
        ...
        self._create_develop_branch = None
        ...
        if create_develop_branch is not None:
            self.create_develop_branch = create_develop_branch
    ...
    def create_develop_branch(self):
        """Gets the create_develop_branch of this CreateRepoOption.  # noqa: E501

        Whether to initialize the repository with a secondary develop branch  # noqa: E501

        :return: The create_develop_branch of this CreateRepoOption.  # noqa: E501
        :rtype: bool
        """
        return self._create_develop_branch

    @create_develop_branch.setter
    def create_develop_branch(self, create_develop_branch):
        """Sets the create_develop_branch of this CreateRepoOption.

        Whether to initialize the repository with a secondary develop branch  # noqa: E501

        :param create_develop_branch: The create_develop_branch of this CreateRepoOption.  # noqa: E501
        :type: bool
        """

        self._create_develop_branch = create_develop_branch
