...
request_body_edit_label_option = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextHtml = Label
...
class BaseApi(api_client.Api):
    ...
    def _org_edit_label_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_edit_label_option.serialize(body, content_type)
