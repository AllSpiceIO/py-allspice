...
request_body_edit_hook_option = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextHtml = Hook
...
class BaseApi(api_client.Api):
    ...
    def _org_edit_hook_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_edit_hook_option.serialize(body, content_type)
