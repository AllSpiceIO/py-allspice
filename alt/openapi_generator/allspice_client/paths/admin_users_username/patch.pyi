...
request_body_edit_user_option = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextHtml = User
...
class BaseApi(api_client.Api):
    ...
    def _admin_edit_user_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_edit_user_option.serialize(body, content_type)
