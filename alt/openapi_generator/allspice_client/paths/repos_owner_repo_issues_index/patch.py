...
request_body_edit_issue_option = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextHtml = Issue
...
class BaseApi(api_client.Api):
    ...
    def _issue_edit_issue_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_edit_issue_option.serialize(body, content_type)
