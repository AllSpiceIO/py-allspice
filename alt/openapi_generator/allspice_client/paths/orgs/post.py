...
request_body_create_org_option = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextHtml = Organization
...
class BaseApi(api_client.Api):
    ...
    def _org_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_org_option.serialize(body, content_type)
