...
request_body_add_time_option = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextHtml = TrackedTime
...
class BaseApi(api_client.Api):
    ...
    def _issue_add_time_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_time_option.serialize(body, content_type)
