...
request_body_create_label_option = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextHtml = Label
...
class BaseApi(api_client.Api):
    ...
    def _issue_create_label_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_label_option.serialize(body, content_type)
