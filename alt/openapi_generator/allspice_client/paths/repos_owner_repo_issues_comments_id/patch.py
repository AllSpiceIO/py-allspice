...
request_body_edit_issue_comment_option = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextHtml = Comment
...
class BaseApi(api_client.Api):
    ...
    def _issue_edit_comment_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_edit_issue_comment_option.serialize(body, content_type)
