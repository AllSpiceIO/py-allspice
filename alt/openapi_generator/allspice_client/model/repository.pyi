...
class Repository(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def parent() -> typing.Type['Repository']:
                return Repository
        
            @staticmethod
            def permissions() -> typing.Type['Permission']:
                return Permission
            private = schemas.BoolSchema
            release_counter = schemas.Int64Schema
        
            @staticmethod
            def repo_transfer() -> typing.Type['RepoTransfer']:
                return RepoTransfer
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parent"]) -> 'Repository': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["permissions"]) -> 'Permission': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["repo_transfer"]) -> 'RepoTransfer': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parent"]) -> typing.Union['Repository', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["permissions"]) -> typing.Union['Permission', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["repo_transfer"]) -> typing.Union['RepoTransfer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        parent: typing.Union['Repository', schemas.Unset] = schemas.unset,
        permissions: typing.Union['Permission', schemas.Unset] = schemas.unset,
        ...
        repo_transfer: typing.Union['RepoTransfer', schemas.Unset] = schemas.unset,
