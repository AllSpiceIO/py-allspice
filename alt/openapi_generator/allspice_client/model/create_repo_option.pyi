...
class CreateRepoOption(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            create_develop_branch = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["create_develop_branch"]) -> MetaOapg.properties.create_develop_branch: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "auto_init", "create_develop_branch", "default_branch", "description", "gitignores", "issue_labels", "license", "private", "readme", "template", "trust_model", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["create_develop_branch"]) -> typing.Union[MetaOapg.properties.create_develop_branch, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "auto_init", "create_develop_branch", "default_branch", "description", "gitignores", "issue_labels", "license", "private", "readme", "template", "trust_model", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        create_develop_branch: typing.Union[MetaOapg.properties.create_develop_branch, bool, schemas.Unset] = schemas.unset,
