...
class PullReview(ReadonlyApiObject):
    """
    ...
    _fields_to_parsers: ClassVar[dict] = {
        "user": lambda allspice_client, u: User.parse_response(allspice_client, u),
        "state": lambda _, s: PullReview.ReviewEvent(s),
    }
...
class DesignReview(ApiObject):
    ...
    def create_review(
        ...
        *,
        body: Optional[str] = None,
        event: Optional[PullReview.ReviewEvent] = None,
        comments: Optional[List[PullReview.ReviewComment]] = None,
        ...
        return PullReview.parse_response(self.allspice_client, result)

    def get_reviews(self) -> List[PullReview]:
        """
        ...
        return [PullReview.parse_response(self.allspice_client, result) for result in results]

    def submit_review(
        self,
        review_id: int,
        event: PullReview.ReviewEvent,
        *,
        body: Optional[str] = None,
    ):
        """
